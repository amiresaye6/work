...
function main() {
  const inputFile = 'output7.5.json';
  ...
  fs.writeFileSync('products6_en.json', JSON.stringify(output_en, null, 2), 'utf8');
  fs.writeFileSync('products6_ar.json', JSON.stringify(output_ar, null, 2), 'utf8');
