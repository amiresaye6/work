...
function main() {
  ...
  fs.writeFileSync('products14_en.json', JSON.stringify(output_en, null, 2), 'utf8');
  fs.writeFileSync('products14_ar.json', JSON.stringify(output_ar, null, 2), 'utf8');
